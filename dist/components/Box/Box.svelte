...
export let elementRef = defaultBoxProps.elementRef;
export let as = defaultBoxProps.as;
export let display = defaultBoxProps.display;
$: cssClass = clsx($$restProps.class, 'Box', {
