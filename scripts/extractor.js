...
const getVariableTypes = (lines, options) => {
    ...
    svelteSource
        ...
        .filter((v) => v.hasExportKeyword() && v.getDeclarationKind() == VariableDeclarationKind.Let)
        .forEach((v) => {
            ...
            declarations.forEach((declaration) => {
                ...
                else if (declaration.getChildrenOfKind(ts.SyntaxKind.TrueKeyword).length)
                    variable.assignedValue = true;
                else if (declaration.getChildrenOfKind(ts.SyntaxKind.FalseKeyword).length)
                    variable.assignedValue = false;
